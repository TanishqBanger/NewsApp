...
export class NewsItem extends Component {
  ...
  render() {
    ...
    return (
      ...
      <p className="card-text"><small className="text-body-secondary">By {!author?"unknown": author} on {new Date(date).toGMTString()}</small></p> {/*// if author is null then we are using unknown here */}
