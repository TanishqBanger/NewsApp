...
export class News extends Component {
  ...
  async updateNews(pageNo){
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=5005f995ad7744ffbdcd33754b6cfb1f&page=1&pageSize=${this.props.pageSize}`;
