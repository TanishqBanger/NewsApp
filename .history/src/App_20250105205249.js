...
class App extends Component {
  render() {
    return (
      ...
      <Route path='/entertainment' element={<News pageSize={5} country="us" category="business"/>} />
      <Route path='/general' element={<News pageSize={5} country="us" category="business"/>} />
      <Route path='/health' element={<News pageSize={5} country="us" category="business"/>} />
      <Route path='/science' element={<News pageSize={5} country="us" category="business"/>} />
      <Route path='/sports' element={<News pageSize={5} country="us" category="business"/>} />
      <Route path='/technology' element={<News pageSize={5} country="us" category="business"/>} />
