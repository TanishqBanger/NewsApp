  ...
  render() {
    return (
      ...
      <Route exact path='/technology' element={<News setProgress={this.setProgress apikey={apikey}} key="technology" pageSize={this.pageSize} country="us" category="technology"/>} />
        ...
        {/* <Route path="/"><News setProgress={this.setProgress apikey={apikey}} pageSize={this.pageSize} country="us" category="general"/></Route>
        <Route path="/business"><News setProgress={this.setProgress apikey={apikey}} pageSize={this.pageSize} country="us" category="business"/></Route>
        <Route path="/entertainment"><News setProgress={this.setProgress apikey={apikey}} pageSize={this.pageSize} country="us" category="entertainment"/></Route>
        <Route path="/general"><News setProgress={this.setProgress apikey={apikey}} pageSize={this.pageSize} country="us" category="general"/></Route>
        <Route path="/health"><News setProgress={this.setProgress apikey={apikey}} pageSize={this.pageSize} country="us" category="health"/></Route>
        <Route path="/science"><News setProgress={this.setProgress apikey={apikey}} pageSize={this.pageSize} country="us" category="science"/></Route>
        <Route path="/sports"><News setProgress={this.setProgress apikey={apikey}} pageSize={this.pageSize} country="us" category="sports"/></Route>
        <Route path="/technology"><News setProgress={this.setProgress apikey={apikey}} pageSize={this.pageSize} country="us" category="technology"/></Route> */}
      </Router>
      </div>
    );
  }
